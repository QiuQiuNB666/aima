...
- **9/23 新增**：台阶手感按球球穿真机的反馈反过来（上台阶 = 支撑期阻力，摆动期不压腿；下台阶 = 落阶冲击 + 助力）；珠峰北坡（56 步）；屋顶跑酷 `/parkour`（步频 = 跑速，捷风追你）；大屏「腿上的力」波形 + AI 决策卡。展位启动 `./run-mac.sh --ctl terrain --stepping --cap 4 --strength 3.0 --width 16 --http 8765`
...
| ![泰山十八盘登顶](docs/提交/截图/游戏-泰山登顶.png) | ![上台阶一周期力矩：支撑期阻力，摆动期不压腿](docs/提交/截图/脉冲-上台阶-阻力.png) |
