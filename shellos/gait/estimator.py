...
# 9/23 下午：stride_min 0.8 → 0.6。0.8 s = 步频上限 150 步/分，真人一跑（160–180）大半周期被拒，化身跑起来和走路一样快。
# 0.6 s = 200 步/分。gait_audit 单维扫描：0.6 穿戴假周期 0、覆盖率 0.32→0.33；0.5 会多 1 个穿戴假周期，所以停在 0.6。
DEFAULTS = dict(stride_min=0.6, stride_max=2.2, cycle_conf=-1.0, rom_min=15.0, sync_tol=0.2)
