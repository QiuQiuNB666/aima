...
| 成片 | 内容 |
|---|---|
| v1_60s.mp4 | V3 第 1 轮：全部游戏画面用最新 main 重渲（峰哥新身体 + 珠峰羽绒服、维塔跟跑、直升机 / 牦牛 / 帐篷 / 排队者、横梯 / 刀脊 / 横切、风雪云海）+ 峰哥克隆声旁白 + 游戏内峰哥台词同期声 + CC BY 配乐；实拍位占位卡 |
| v2_60s.mp4 | 第 2 轮：分镜掐点（前 5 秒先给结果）、字幕重做（深底霓虹紫）、0.3 s 淡入淡出、片头片尾 |
| v3_60s.mp4 / v3_90s.mp4 | 第 3 轮：亮度对齐、旁白与画面事件对拍、登顶后留白落章、90 s 加长版 |
